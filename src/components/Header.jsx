  ...
  <div className="shadow-sm border-b sticky">
   ...
   {isOpen && (
    <Modal
     ...
     className="max-w-lg w-[90%] p-5 absolute top-[20%] left-[50%] translate-x-[-50%]  border-2 border-amber-300 rounded-xl shadow-sm bg-amber-200 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10"
     ariaHideApp={false}
    >
